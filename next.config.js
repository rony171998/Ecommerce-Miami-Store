...
module.exports = {
  ...
  async rewrites() {
    return [
      {
        source: '/category/:slug', // La ruta en la URL
        destination: '/category/[slug]', // La ruta real del componente
      },
      {
        source: '/product/:slug', // La ruta en la URL
        destination: '/product/[slug]', // La ruta real del componente
      },
    ];
  },
};
